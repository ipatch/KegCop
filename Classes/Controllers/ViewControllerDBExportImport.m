...
//#endif
    ...
    NSMutableURLRequest *request = [[AFHTTPRequestSerializer serializer] multipartFormRequestWithMethod:@"POST" URLString:[NSString stringWithString:filename] parameters:nil constructingBodyWithBlock:^(id<AFMultipartFormData> formData) {
    ...
    uploadTask = [manager uploadTaskWithStreamedRequest:request progress:nil
